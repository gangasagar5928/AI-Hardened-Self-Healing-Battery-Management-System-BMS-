"""
Generates Cyber_Hardened_BMS_Manual.docx with >10,000 WORDS and embedded images.
"""
...
# EXPANDED CHAPTERS 25-39 FOR FULL 10,000+ WORD COUNT
...
add_sec(doc, "Chapter 26 — Team Roles & Daily Task Breakdown", [
    ...
    ("bullet", "Member 1 (Hardware Lead): Responsible for BOM component procurement, 4S battery pack cell tap soldering, BQ76920 AFE breakout wiring, LM2596S power supply regulation, and KiCad 8.0 PCB schematic and layout design."),
    ("bullet", "Member 2 (Firmware Lead): Responsible for ESP32 FreeRTOS dual-core task partition, TWAI CAN driver setup, I2C driver integration, OLED display sketch development, and C++ ids_model.h integration."),
    ("bullet", "Member 3 (ML & Data Security Lead): Responsible for CAN bus attack simulation scripts (attacker_node.ino), serial telemetry dataset capture (generate_dataset.py), feature engineering, scikit-learn Random Forest model training, and m2cgen C++ code export."),
    ("bullet", "Member 4 (Simulation & Modeling Lead): Responsible for LTspice passive balancing subcircuit simulation, MATLAB/Simulink 1RC equivalent circuit model construction, EKF algorithm derivation, and R-scaling parameter tuning."),
    ("bullet", "Member 5 (Project Manager & IP Lead): Responsible for weekly task tracking, budget management, authoring the 6-8 page IEEE conference paper draft, and completing the Indian Patent Office Form 2 provisional specification.")
])
